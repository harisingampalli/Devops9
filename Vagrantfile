  ...
  #  config.vm.provision :shell, :path => "bootstrap.sh"
    ...
    #web.vm.network :private_network, ip: "172.18.1.20"
  ...
  config.vm.define "db" do |db|
    ...
    #db.vm.network :private_network, ip: "172.18.1.30"
  ...
  config.vm.define "boss" do |boss|
    ...
    #boss.vm.network :private_network, ip: "172.18.1.40"
    boss.vm.network :private_network, ip: "192.168.56.40"
 ...
 config.vm.define "master" do |master|
    ...
    #master.vm.network :private_network, ip: "172.18.1.50"
  ...
  config.vm.define "docker" do |docker|
    ...
    #docker.vm.network :private_network, ip: "172.18.1.60"
	docker.vm.network :private_network, ip: "192.168.56.60"
   # boss.vm.synced_folder "./Vagrant-demo", "./vagrant"
